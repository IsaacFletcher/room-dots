...
sudo pacman -S papirus-icon-theme python-gobject python-pywal sddm git base-devel hyprland alacritty xdg-desktop-portal-hyprland waybar swaync rofi qt6ct qt5ct dolphin kvantum cliphist
